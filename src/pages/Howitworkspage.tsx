    ...
    <main className="flex-1">
      <section className="px-6 md:px-20 lg:px-40 py-16 text-center lg:text-left flex flex-col lg:flex-row items-center justify-between gap-12">
        <div className="max-w-2xl mt-12">
          ...
          <div className="mt-10 flex flex-wrap gap-4 justify-center lg:justify-start">
            <button className="bg-(--primary) text-white px-8 py-4 rounded-xl font-bold text-lg hover:shadow-lg hover:bg-(--primary/10) transition-all">
              Start Browsing
            </button>
            <button className="bg-(--primary/10) text-(--primary) px-8 py-4 rounded-xl font-bold text-lg hover:bg-(--primary) hover:text-white transition-all border border-(--primary/10)">
              List an item
            </button>
          </div>
        </div>
      ...
      <section className="px-6 md:px-20 lg:px-40 py-20 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          <div className="flex flex-col items-center text-center relative z-10">
            ...
            <span className="text-(--primary) uppercase font-bold text-sm tracking-widest">
              step 1
            </span>
            <h3 className="text-xl font-bold mt-1 text-slate-900">
              List Your Item
            </h3>
            <p className="text-(--text-shade) tracking-wide">
      ...
      <section className="px-6 md:px-20 lg:px-40 py-24">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            <h2 className="leading-tight text-4xl font-bold mb-8">
              Why chose
              <br />
              <span className="text-(--primary) text-4xl">GarageSwap?</span>
            </h2>
      ...
      <section className="px-6 md:px-20 lg:px-40 py-20">
        <div className="bg-(--primary) rounded-4xl p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-(--primary-shaded)">
          ...
          <button className="bg-white text-(--primary) px-10 py-5 rounded-xl z-10 relative font-bold shadow-xl hover:bg-slate-100 text-xl md:text-xl transition-all">
